...
SELECT 
	first_name,
	ROUND(AVG(datediff(termdate,hire_date))/365,0) AS leng_of_employment
FROM hr
WHERE termdate <= curdate() AND termdate <> 0000-00-00 AND age>=18
GROUP BY first_name
ORDER BY leng_of_employment DESC;

-- AVG employment period
...
SELECT
    ...
    jobtitle,
    gender,
    count(*) as dist_gender
FROM hr
WHERE age>=18 AND termdate = 0000-00-00
GROUP BY department , gender , jobtitle
ORDER BY dist_gender DESC;
